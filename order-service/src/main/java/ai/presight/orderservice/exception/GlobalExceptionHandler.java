 ...
 * Centralizes application-level error handling and response formatting.
 */
@Slf4j
@ControllerAdvice
public class GlobalExceptionHandler {
   ...
   /**
     * Handles business logic violations such as insufficient stock.
     */ 
     ...
     * Ensures internal exceptions are logged but not exposed in detail.
     */
